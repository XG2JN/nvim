...
function M.core_mappings(mappings)
  ...
  if maps then
    ...
    maps.n["J"] = { "5j",desc = "move 5 line down", silent = true }
    maps.n["K"] = { "5k",desc = "move 5 line up", silent = true }
    -- maps.n["S"] = { ":w<CR>", desc = "Save file", silent = true }
    ...
    if system == "Darwin" then
      ...
      maps.n["<leader>a"] = { "<Cmd>w<cr>", desc = "Save file", silent = true }
    end
    ...
    maps.n["<Leader><cr>"] = { ":nohlsearch<CR>", desc = "Close search highlight", silent = true }
